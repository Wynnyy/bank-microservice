...
import sk.app.account.AccountRepository;
...
import sk.app.model.mapper.TransferMapper;
...
public class TransferServiceImpl implements TransferService {
    ...
    @Autowired
    public TransferServiceImpl(TransferMapper transferMapper, TransferRepository transferRepository, AccountRepository accountRepository) {
    ...
    public TransferDto transferCredit(String creditorIban, String debtorIban, BigDecimal amount, String message) throws Exception {
        ...
        return transferMapper.toDto(transferRepository.save(initTransfer(creditorIban, debtorIban, amount, message, fromAccount.getId())));
    }
    ...
    public List<TransferDto> getTransitions(Long accountId) {
        ...
        return transferMapper.toDtoList(transfer);
    }


    @Override
    public List<TransferDto> getSpecificTransitions(BigDecimal amount, String debtorIban, String message, Long accountId) {
        return transferMapper.toDtoList(transferRepository.getSpecificTransfers(amount, debtorIban, message, accountId));
    }
}
